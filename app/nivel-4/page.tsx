              ...
              <CardContent>
                <Accordion type="single" collapsible>
                      ...
                      <div className="space-y-4 text-sm">
                        <div>
                          ...
                          <ul className="space-y-1 text-green-600">
                            <li>
                              • Carrera vacía #1: acercamiento sin recargarse o
                              apoyarse sobre tabla
                            </li>
                            <li>• Entrenador parado entre botador y tabla</li>
                            <li>
                              • Uso botador alternativo (trampolín o botador
                              junior)
                            </li>
                          </ul>
                        </div>
                        <div>
                          ...
                          <ul className="space-y-1 text-red-600">
                            ...
                            <li>
                              • Realizar salto incorrecto (ejemplo: salto a
                              cuclillas)
                            </li>
                            <li>
                              • No alcanzar vertical y regresar o aterrizar en
                              tabla entre botador y manos
                            </li>
                            <li>• Ayuda del entrenador en cualquier fase</li>
                            <li>
                              • Correr sobre botador y subir/rebotar sin usar
                              pies como base
                            </li>
                          </ul>
                        </div>
                        ...
                        <div className="grid gap-3 md:grid-cols-2">
                          <div>
                            ...
                            <ul className="space-y-1 text-yellow-600">
                              <li>
                                • Dinamismo insuficiente (velocidad o potencia)
                              </li>
                              <li>• Desviación dirección recta</li>
                              <li>
                                • Aceleración insuficiente durante carrera
                              </li>
                              <li>
                                • No mantener velocidad horizontal hacia botador
                                (pasos disparejos)
                              </li>
                              <li>
                                • Inclinación excesiva del cuerpo hacia adelante
                                en contacto botador
                              </li>
                              <li>
                                • Desviación dirección por contacto inicial con
                                colchón
                              </li>
                            </ul>
                          </div>
                          <div>
                            ...
                            <ul className="space-y-1 text-yellow-600">
                              ...
                              <li>
                                • 0.30 - No mantener cuerpo extendido - arqueada
                              </li>
                              <li>
                                • 0.50 - No mantener cuerpo extendido - carpada
                              </li>
                            </ul>
                          </div>
                        </div>
                  ...
                  <AccordionItem value="penalizaciones-apoyo-tabla">
                    <AccordionTrigger className="text-sm">
                      Penalizaciones de Apoyo en Tabla
                    </AccordionTrigger>
                    <AccordionContent>
                      <div className="space-y-3 text-sm">
                        <div>
                          ...
                          <ul className="space-y-1 text-red-600">
                            ...
                            <li>
                              • Prohibido - Contacto cabeza con tabla en apoyo
                            </li>
                            <li>
                              • Prohibido - No hacer contacto con ambas manos
                            </li>
                            <li>
                              • Colocación adicional de manos (pasos o brincos)
                            </li>
                            <li>• Mucho tiempo en apoyo</li>
                            <li>• Tocar tabla con solo una mano</li>
                            <li>
                              • Ángulo de rechace (no abandonar tabla antes de
                              vertical)
                            </li>
                          </ul>
                        </div>
                    ...
                    <AccordionContent>
                      <div className="space-y-3 text-sm">
                        <div>
                          ...
                          <ul className="space-y-1 text-green-600">
                            <li>
                              • Distancia insuficiente evaluada según estatura y
                              trayectoria
                            </li>
                        ...
                        <div className="grid gap-3 md:grid-cols-2">
                          <div>
                            ...
                            <ul className="space-y-1 text-yellow-600">
                              <li>
                                • 0.05 - Aterrizar con pies separados al ancho
                                de la cadera o más
                              </li>
                              <li>
                                • 0.10 - Deslizamiento de pies para juntarse
                              </li>
                              <li>• 0.10 - Brinco o ajuste pequeño de pies</li>
                              <li>• 0.10 - Pies escalonados</li>
                              <li>
                                • 0.20 - Salto o paso largo (~1 metro o más)
                              </li>
                              <li>
                                • 0.20 - Postura incorrecta en el aterrizaje
                              </li>
                              <li>
                              ...
                              <li>
                                • 0.30 - Sentadilla en aterrizaje (cadera a la
                                altura de rodillas)
                              </li>
                              <li>
                                • 0.30 - Ligero toque o roce de manos sin apoyo
                              </li>
                            </ul>
                          </div>
                          <div>
                            ...
                            <ul className="space-y-1 text-red-600">
                              ...
                              <li>
                                • 0.50 - Deducción adicional por caída tras
                                ayuda entrenador
                              </li>
                              <li>
                                • 0.50 - Apoyo en colchón con una o dos manos
                              </li>
                              <li>
                              ...
                              <li>
                                • 0.50 - No aterrizar con parte inferior de pies
                                primero
                              </li>
                              <li>
                                • 0.50 + 2.00 - Aterrizaje en posición sentada,
                                acostada o de pie sobre tabla después de pasar
                                vertical
                              </li>
                            </ul>
                          </div>
